...
public class MeetingController {
	...
	@PostMapping
	public ResponseEntity<MeetingDTO> createMeeting(@PathVariable UUID clubId, @RequestParam UUID hostId,
	...
	public ResponseEntity<MeetingDTO> getMeeting(@PathVariable UUID clubId, @PathVariable UUID meetingId) {

		return ResponseEntity.ok(meetingService.getMeeting(clubId, meetingId));
	}

	@PutMapping("/{meetingId}")
	public ResponseEntity<MeetingDTO> updateMeeting(@PathVariable UUID clubId, @PathVariable UUID meetingId,
	...
	public ResponseEntity<Void> deleteMeeting(@PathVariable UUID clubId, @PathVariable UUID meetingId) {
