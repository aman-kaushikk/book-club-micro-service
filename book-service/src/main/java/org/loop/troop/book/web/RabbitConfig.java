...
public class RabbitConfig {
	...
	RetryTemplate retryTemplate() {
		...
		backOffPolicy.setInitialInterval(500); // Initial retry interval
		backOffPolicy.setMultiplier(10.0); // Multiplier for exponential backoff
		backOffPolicy.setMaxInterval(10000); // Maximum interval
